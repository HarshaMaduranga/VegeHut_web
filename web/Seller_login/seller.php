...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        <div style="max-width: 500px; margin: 40px auto; padding: 20px; background: #e6ffed; border: 2px solid #28a745; border-radius: 10px; text-align: center; font-family: sans-serif;">
            ...
            <a href="signup.html" style="display: inline-block; margin-top: 10px; padding: 10px 20px; background-color: #28a745; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">
    OK
</a>
